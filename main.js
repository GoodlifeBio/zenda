  ...
  function initHeroText() {
    ...
    childNodes.forEach(function (node) {
      ...
      if (node.nodeType === Node.TEXT_NODE) {
        ...
        text = node.textContent;
        wrapperTag = node.tagName.toLowerCase();
      } else {
        return;
      }
      ...
      words.forEach(function (word, wIdx) {
        ...
        var charContainer = wordSpan;
        if (wrapperTag) {
          var wrapperEl = document.createElement(wrapperTag);
          wordSpan.appendChild(wrapperEl);
          charContainer = wrapperEl;
        }
